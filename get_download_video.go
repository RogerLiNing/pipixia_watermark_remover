...
func getVideoDownloadLink(videoId string) (string, error) {
	client := &http.Client{}
	url := "https://api.huoshan.com/hotsoon/item/video/_source/?video_id=" + videoId + "&line=0&app_id=0&vquality=normal&watermark=0&sf=5"
